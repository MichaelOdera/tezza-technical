...
public record CreateProductDto(@NotBlank String code, @NotBlank String name, @Min(1) int tenureValue,
                               @NotBlank String tenureUnit, @NotBlank String serviceFeeType,
